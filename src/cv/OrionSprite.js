...
cv.OrionSprite = function(root, element, cssClass, config) {
	//super(config);
...
cv.OrionSprite.prototype = new cv.orion.Orion();
cv.OrionSprite.constructor = cv.OrionSprite;

//--------------------------------------
//  Properties
//--------------------------------------

cv.OrionSprite.prototype.getRoot = function() { return this._root; }

cv.OrionSprite.prototype.getCSSClass = function() { return this._cssClass; }
cv.OrionSprite.prototype.setCSSClass = function(value) {
	this._cssClass = value;
	this.removeAllParticles();
}

cv.OrionSprite.prototype.getElement = function() { return this._element; }
cv.OrionSprite.prototype.setElement = function(value) {
	this._element = value;
	this.removeAllParticles();
}
...
cv.OrionSprite.prototype.render = function(e) {
...
cv.OrionSprite.prototype.hex2css = function(color) {
	var col = color.toString(16);
	while(col.length < 6) col = "0" + col;
	return "#" + col;
}

cv.OrionSprite.prototype.additionalInit = function(p, pt) {
...
cv.OrionSprite.prototype.createParticle = function(idx) {
	// Create new particle
...
cv.OrionSprite.prototype.removeParticle = function(p) {
